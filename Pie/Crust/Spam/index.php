	...
	<div class="columnholder bg5">
		...
		<div class="column row">
			<div class="one">
				<div class="content center">
					...
					<div class="row connect">
						<p class="bree sp2">
							<img src="/Pie/Crust/Template/img/twitter-bird-light-bgs.png" height="126" alt="Twitter Connect" />
			...
			<div class="row one">
				<h2>Fakers List</h2>
				<?=$spamrecords;?>
				<div class="one textright">
					<p class="sm1"><a href="/Fakers/Wall">See more...</a></p>
				</div>
			</div>
		</div>
	</div>
